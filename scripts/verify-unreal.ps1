...
& node src/cli.ts batch unreal $spec $revisionSpec $numericProjectionSpec $portableSpec $compoundEvidenceSpec $conditionalEffectsSpec $multiFieldConformanceSpec $resultSemanticsSpec --out-dir $fixtureGenerated --flat --profile $editorProfile --force
