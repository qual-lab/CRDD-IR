...
$collectionEvaluationSource = Join-Path $repository "test\fixtures\contracts\collection-evaluation.md"
$sources = @($Source, $portableSource, $compoundEvidenceSource, $conditionalEffectsSource, $multiFieldConformanceSource, $resultSemanticsSource, $collectionEvaluationSource) |
